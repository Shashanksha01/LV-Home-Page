...
import { womenCollection } from "../assets/assets";
...
const WomenCollection = () => {
  return (
    <div className="px-4 sm:px-8 md:px-16 lg:px-32 xl:px-40 pb-20 mt-15">
      <div>
        <p className="text-center font-light text-xs mb-5">WOMEN</p>
        <p className="text-center mb-6 font-medium text-3xl">Pre-Fall 2025</p>
